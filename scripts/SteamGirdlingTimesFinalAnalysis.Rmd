...
```{r}
#Look at absorbance data of all treatments with mass removed
...
Mass_model = glm(Abs_Mass ~ Trmt, data = all_peas, family = Gamma())

summary(Mass_model)
Anova(Mass_model, type =3)
```
...
#Make aesthetically pleasing mass corrected boxplot
...
```{r}
#Create aesthetically pleasing histogram of controls
